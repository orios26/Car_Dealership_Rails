...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Customer.create!(last_name: 'Rand', first_name: 'Dee', address: '2 Northview Crossing', email: 'dbrand@china.com.cn', phone: '287-936-2554')
    Customer.create!(last_name: 'B', first_name: 'D', address: '2 Northview Crossing', email: 'brand2@china.com.cn', phone: '287-936-2554')
    Customer.create!(last_name: 'and', first_name: 'D', address: '2 Northview Crossing', email: 'dd2@china.com.cn', phone: '287-936-2554')
